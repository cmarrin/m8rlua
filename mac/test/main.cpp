...
lua::LuaScriptingLanguage luaScriptingLanguage;

const char* fileList[] = {
    "scripts/timing/timing.lua",
};
...
int main(int argc, char * argv[])
{
    ...
    m8r::system()->registerScriptingLanguage(&luaScriptingLanguage);
    ...
    application.runAutostartTask("/sys/bin/timing.lua");
